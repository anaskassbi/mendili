...
<head>
    ...
    <title>Al Mendili Suites junior</title>
...
<body> <a style="float: left; margin: 10px 0 0 10px;" href="#" id="playbutton" data-lity>
    ...
    <div class="home">
        ...
        <div class="center">
            ...
            <div class="center_txt">
                <div class="block_txt_center" style="float:left; width:400px; padding:25px 0 0 0; margin-left: 70px;">
