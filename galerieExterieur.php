...
<head>
    ...
    <title>El Mendili de l'exterieur</title>
    ...
    <script type="text/javascript">
        ...
        for (i = 1; i < 6; i++) {
            ...
            html += "<a href='./images/bg/exterieur/" + i + ".jpg' style='display:none' class='lsb-preview'" +
                ...
                "<img src='./images/bg/exterieur/" + i + ".jpg' >" +
                "</a>"
        }
        $("#mimages").append(html)
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "images/bg/exterieur/1.jpg")', 7800);
            }
        });
    ...
    <div class="home">
        ...
        <div class="sous_menu">
            <ul>
                ...
                <li><a href="galerieExterieur.php" class="selectedL"><?php echo $lang["exterieur"]; ?></a></li>
