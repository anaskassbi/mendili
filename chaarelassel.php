    ...
    <script type="text/javascript">
        ...
        for (i=1; i < 6; i++) {
            ...
            html += "<a href='./images/chambres/Suite Prestige/CHAAR EL ASSEL/" + i + ".jpeg'  class='lsb-preview'" +
                ...
                "<img src='./images/chambres/Suite Prestige/CHAAR EL ASSEL/" + i + ".jpeg'" +
                "</a>"
        }
        $("body").append(html)
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "/images/chambres/Suite Prestige/CHAAR EL ASSEL/1.jpg")', 7800);
            }
        });
                ...
                <div class="block_txt_center" style="width:411px; float:left; margin-left:150px">
                    <div class="scroll-pane" style="width:390px;">
                        ...
                        <div class="mimages" id="mimages">
                            <a href="images/chambres/Suite Prestige/CHAAR EL ASSEL/1.jpeg" class="lsb-preview &quot2&quot"
                                data-lsb-group="gallery1" id="gallery">
                                <img src="images/bg/chambres/assel.png" class="mosaique" alt=""
