...
<body> <a style="float: left; margin: 10px 0 0 10px;" href="#" id="playbutton" data-lity class="fa-play">
    ...
    <script type="text/javascript">
        ...
        var html = ""
        for (i=1; i < 5; i++) {
            images.push({ image: "images/chambres/Suite Prestige/EL MAMLAKA/" + i + ".jpeg" })
            html += "<a href='./images/chambres/Suite Prestige/EL MAMLAKA/" + i + ".jpeg'  class='lsb-preview'" +
                "data-lsb-group='gallery1' style='display:none'>" +
                "<img src='./images/chambres/Suite Prestige/EL MAMLAKA/" + i + ".jpeg'" +
                "</a>"
        }
        $("body").append(html)
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "/images/chambres/Suite Prestige/EL MAMLAKA/1.jpg")', 7800);
            }
        });
    ...
    <div class="home">
        ...
        <div class="sous_menu" style="">
            <ul>
                ...
                <li><a href="prestige.php" class="selectedL">Suits Prestige</a></li>
            </ul>
        </div>
        <div class="center">
            <div class="center_txt">
                <div class="block_txt_center" style="width:411px; float:left; margin-left:150px">
                    <div class="scroll-pane" style="width:390px;">
                        <h2 style="margin-top: 70px; font-size: 24px;"> EL MEMLAKA </h2>
                        <?php echo $lang["elmamlaka"] ?>
                        <div class="mimages" id="mimages">
                            <a href="images/chambres/Suite Prestige/EL MAMLAKA/1.jpeg"
                                class="lsb-preview &quot2&quot" data-lsb-group="gallery1" id="gallery">
                                <img src="images/bg/chambres/mamlaka.png" class="mosaique"
                                    alt="" width="328" height="240">
                            </a>
                        </div>
                    </div>
                </div>
