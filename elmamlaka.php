    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "./images/chambres/Suite Prestige/EL MAMLAKA/1.jpeg")', 7800);
            }
        });
                ...
                <div class="block_txt_center" style="width:411px; float:left; margin-left:150px">
                    <div class="scroll-pane" style="width:390px;">
                        ...
                        <div class="mimages" id="mimages">
                            <a href="images/chambres/Suite Prestige/EL MAMLAKA/1.jpeg" class="lsb-preview &quot2&quot"
                                data-lsb-group="gallery1" id="gallery">
                                <img src="images/bg/chambres/mamlaka.png" class="mosaique show" alt="" width="328"
                                    height="240">
                            </a>
                        </div>
                    </div>
