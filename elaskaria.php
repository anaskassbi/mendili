    ...
    <script type="text/javascript">
        ...
        for (i=1; i < 4; i++) {
            ...
            html += "<a href='./images/chambres/Chambre Deluxe/EL ASKARIA/" + i + ".jpeg'  class='lsb-preview'" +
                ...
                "<img src='./images/chambres/Chambre Deluxe/EL ASKARIA/" + i + ".jpeg'" +
                "</a>"
        }
        $("body").append(html)
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "images/chambres/Chambre Deluxe/EL ASKARIA/1.jpeg")', 7800);
            }
        });
            ...
            <div class="center_txt">
                <div class="block_txt_center" style="width:411px; float:left; margin-left:150px">
                    <div class="scroll-pane" style="width:390px;">
                        <h2 style="margin-top: 70px; font-size: 24px;">EL ASKARIA</h2>
                        <?php
                        echo $lang["elaskaria"]
                            ?>
                        <div class="mimages" id="mimages">
                            <a href="images/chambres/Chambre Deluxe/EL ASKARIA/1.jpeg" class="lsb-preview &quot2&quot"
                                ...
                                <img src="images/bg/chambres/askaria.png" class="mosaique show" alt=""
