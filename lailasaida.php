    ...
    <script type="text/javascript">
        ...
        for (i = 1; i < 5; i++) {
            ...
            html += "<a href='./images/chambres/Chambre Deluxe/LAILA SAIDA/" + i + ".jpeg'  class='lsb-preview'" +
                ...
                "<img src='./images/chambres/Chambre Deluxe/LAILA SAIDA/" + i + ".jpeg'" +
                "</a>"
        }
        $("body").append(html)
        ...
        $(document).ready(function () {
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "/images/chambres/Chambre Deluxe/LAILA SAIDA/1.jpeg")', 7800);
            }
        });
