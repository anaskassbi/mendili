...
<body>
    ...
    <script type="text/javascript">
        var images = []
        for (i = 1; i <= 6; i++) {
            images.push({ image: "images/bg/restauration/" + i + ".jpg" })
        }
        ...
        $(document).ready(function () {
            ...
            $('#btnShow').click(function () {
                ...
                $("#frame").attr("src", "images/commun/vins.pdf");
            ...
            $('#btnShowBar').click(function () {
                ...
                $("#frame").attr("src", "images/commun/bar.pdf");
                $("#frame").attr("width", w - 150);
                $("#frame").attr("height", h - 150);
            });
            ...
            if (!isMobile) {
                ...
                setTimeout('$(".slide-0 a img").attr("src", "images/bg/restauration/1.jpg")', 7800);
            }
        });
        ...
        <div class="header">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li><a href="restauration.php" class="selectedL">
                ...
                <div class="block_txt_center" style=" float:left; margin-left:150px">
                    <div class="scroll-pane" style="">
                        ...
                        <h2 style="font-size: 14px;">
                            <?php echo $lang["downloadBar"]; ?>
                        </h2>
                        <p class="localisation-bloc">
                            <a id="btnShowBar" href="#">
                                <img class="show" src="images/commun/barfirstpage.png"
                                    srcset="images/commun/barfirstpage.png" alt="localisation" />
                            </a>
                        </p>
                    </div>
